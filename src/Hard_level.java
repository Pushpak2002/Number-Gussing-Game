...
public class Hard_level extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					int num = 0;
					String name  = "";
					Hard_level frame = new Hard_level(num,name);
	...
	public Hard_level(int n,String n1) {
		num = n;
		name = n1;
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1062, 731);
		...
		btnNewButton.setBounds(646, 479, 127, 67);
		...
		lblNewLabel_1_1.setBounds(513, 337, 135, 61);
		...
		lblNewLabel_4_1.setBounds(321, 178, 521, 27);
